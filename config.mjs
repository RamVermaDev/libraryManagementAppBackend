...
export { PORT, MONGODB_URI, BCRYPT_SALT_ROUND, JWT_SECRET, SMTP_HOST, SMTP_PORT, SMTP_USER, SMTP_PASS, SMTP_FROM, DEFAULT_TRIAL_DAYS, MONTHLY_PRICE, YEARLY_PRICE, RAZORPAY_KEY_ID, RAZORPAY_KEY_SECRET }